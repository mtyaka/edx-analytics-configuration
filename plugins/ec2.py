...
class Ec2Inventory(object):
    ...
    def add_instance(self, instance, region):
        ...
        # Determine route53 domain names
        route53_names = self.get_instance_route53_names(instance) if self.route53_enabled else set()
        if len(route53_names) > 0:
            instance.route53_domain_name = route53_names[0]
        ...
        # Inventory: Group by Route53 domain names
        ...
        for key in vars(instance):
            ...
            if type(value) in [int, bool]:
                ...
                for k, v in value.iteritems():
                    ...
                    if k.startswith('ansible:var:'):
                        key = self.to_safe(k[12:])
                        instance_vars[key] = v
            elif key == 'ec2_groups':
                group_ids = []
                group_names = []
